...
Usage:
    python unsloth-cli-hidden-rule-three-rules-training-avoid-eval-256tokens.py --model_name "unsloth/Qwen3-4B" \
    --dataset "spath_data_gen/data/train_hidden_rule_three_rules_4shot_size6_256tokens.json" \
...
To see a full list of configurable options, use:
    python unsloth-cli-hidden-rule-three-rules-training-avoid-eval-train3to9-test6-256tokens.py --help
"""
