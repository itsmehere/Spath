...
- Size 3-9 graphs (randomly selected per prompt)
...
Usage:
    python unsloth-cli-hidden-rule-three-rules-training-avoid-eval-train3to9-test6-0shot-4shot-6shot-256tokens.py --model_name "unsloth/Qwen3-4B" \
...
NOTE: This version uses max_new_tokens=256 for evaluation.

To see a full list of configurable options, use:
    python unsloth-cli-hidden-rule-three-rules-training-avoid-eval-train3to9-test6-0shot-4shot-6shot-256tokens.py --help
"""
                ...
                try:
                    ...
                    with torch.no_grad():
                        outputs = self.model.generate(
                            **inputs,
                            max_new_tokens=256,  # 256 token limit for evaluation
