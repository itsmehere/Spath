...
# NOTE: Training graphs are sizes 3-9, evaluation graphs are size 6 only
...
echo "TRAIN SIZES 3-9, TEST SIZE 6 ONLY, 256 TOKENS AT EVAL"
echo "========================================"
echo ""
echo "📚 TRAINING:"
...
echo "   - Size: 3-9 (randomly selected per prompt)"
...
echo "   - Per-avoid-node accuracy for all three modes"
echo "========================================"
echo ""

# Run training
python unsloth-cli-hidden-rule-three-rules-training-avoid-eval-train3to9-test6-0shot-4shot-6shot-256tokens.py \
    --model_name "unsloth/Qwen3-4B" \
    --max_seq_length 2048 \
    --load_in_4bit \
    --dataset "spath_data_gen/data/train_hidden_rule_three_rules_4shot_train3to9_test6_256tokens.json" \
    --eval_dataset "spath_data_gen/data/val_hidden_rule_avoid_0shot_4shot_6shot_test6_2048tokens.json" \
    --eval_strategy "steps" \
    --eval_steps 200 \
    --r 64 \
    --lora_alpha 64 \
    ...
    --wandb_entity "spath" \
    --wandb_project "Spath" \
    --wandb_run_name "Spath_hidden_rule_three_rules_training_avoid_eval_train3to9_test6_0shot_4shot_6shot_256tokens" \
    --save_model \
    --save_path "Qwen-3-4b-hidden-rule-three-rules-training-avoid-eval-train3to9-test6-0shot-4shot-6shot-256tokens" \
