...
# Run training
python unsloth-cli-hidden-rule-three-rules-training-avoid-eval-256tokens.py \
    ...
    --wandb_entity "spath" \
    --wandb_project "Spath" \
    --wandb_run_name "Spath_hidden_rule_three_rules_training_avoid_eval_256tokens" \
    --save_model \
    --save_path "Qwen-3-4b-hidden-rule-three-rules-training-avoid-eval-256tokens" \
