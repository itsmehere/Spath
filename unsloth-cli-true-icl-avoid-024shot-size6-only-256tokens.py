...
Usage:
    python unsloth-cli-true-icl-avoid-024shot-size6-only-256tokens.py --model_name "unsloth/Qwen3-4B" \
...
To see a full list of configurable options, use:
    python unsloth-cli-true-icl-avoid-024shot-size6-only-256tokens.py --help
"""
